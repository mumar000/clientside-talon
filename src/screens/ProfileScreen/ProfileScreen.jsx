...
const ProfileScreen = () => {
  ...
  const [updateProfilePic, { isLoading: loading }] =
    useUpdateProfilePicMutation();
  ...
  const bgImage =
    "https://taloninternational.com/wp-content/uploads/2018/07/WWT-1-5.png";
  if (isLoading)
    return (
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br bg-center bg-cover bg-no-repeat from-gray-50 to-gray-100"
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="mt-4 flex justify-center md:justify-start gap-3">
                  ...
                  >
                    {loading ? (
                      <div className="h-6 w-6 border-y-2 boder-l-2 rounded-full border-white animate-spin"></div>
                    ) : (
