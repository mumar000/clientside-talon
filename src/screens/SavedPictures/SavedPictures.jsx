                    ...
                    <div className="max-w-7xl mx-auto px-8 w-full">
                        <div className="max-w-3xl">
                            ...
                            <p className="text-white/80 text-xl font-medium leading-relaxed max-w-2xl">
                                Discover your curated collection of high-quality images, meticulously saved for your inspiration and projects.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                {loading && (
                    <div className="flex justify-center items-center py-20">
                        <div className="text-center">
                            <Spin size="large" />
                            <p className="mt-4 text-gray-600 font-medium">Loading your saved images...</p>
                        </div>
                    </div>
                )}
                ...
                {!loading && pictureUrl.length === 0 && (
                    <div className="flex justify-center items-center py-20">
                        <Empty
                            description={
                                <div className="text-center">
                                    <p className="text-gray-600 text-lg mb-2">No saved images yet</p>
                                    <p className="text-gray-500">Start saving images to see them here</p>
                                </div>
                            }
                        />
                    </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                            {paginatedData.map((url, index) => (
                                ...
                                >
                                    <Image
                                        src={url}
                                        alt={`Saved image ${(currentPage - 1) * pageSize + index + 1}`}
                                        ...
                                        placeholder={
                                            <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 animate-pulse rounded-xl flex items-center justify-center">
