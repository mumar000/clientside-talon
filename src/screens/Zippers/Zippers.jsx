...
const Zippers = () => {
    ...
    return (
        <>
            {isLoading ? (<div><ScreenLoader /></div>) : (
                    ...
                    <div className="w-full relative mb-8">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-black/40 to-transparent flex items-center">
                            <div className="container mx-auto px-8">
                                <h1 className="text-4xl font-bold text-white mb-2">Zippers Collection</h1>
                                <p className="text-white/80 max-w-xl">
                                    Browse our complete collection of high-quality zippers for all your manufacturing needs
                                </p>
                            </div>
                        </div>
                    </div>
